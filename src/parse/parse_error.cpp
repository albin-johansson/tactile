...
auto to_message(parse_error error) -> QString
{
  switch (error) {
    ...
    case parse_error::map_missing_next_layer_id:
      return QStringLiteral(u"Map did not feature \"nextlayerid\" property!");
    ...
    case parse_error::tileset_missing_first_gid:
      return QStringLiteral(u"Tileset did not feature \"firstgid\" property!");
    case parse_error::tileset_missing_tile_width:
      return QStringLiteral(u"Tileset did not feature \"tilewidth\" property!");
    case parse_error::tileset_missing_tile_height:
      return QStringLiteral(u"Tileset did not feature \"tileheight\" property!");
