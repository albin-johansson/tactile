...
auto map_document_manager::add(map_document* document) -> map_id
{
  ...
  bind(&map_document::moved_property_up,      &map_document_manager::moved_property_up);
  bind(&map_document::moved_property_down,    &map_document_manager::moved_property_down);
  bind(&map_document::duplicated_property,    &map_document_manager::duplicated_property);
  // clang-format on
