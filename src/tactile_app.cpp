...
void tactile_app::init_connections()
{
  ...
  modToWin(&mod::about_to_remove_property, &win::about_to_remove_property);
  modToWin(&mod::updated_property,         &win::updated_property);
  modToWin(&mod::renamed_property,         &win::renamed_property);
