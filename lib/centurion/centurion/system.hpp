...
[[nodiscard]] inline auto NowInSeconds() noexcept(noexcept(Seconds<double>{}))
    -> Seconds<double>
{
  return Seconds<double>{static_cast<double>(Now()) /
                         static_cast<double>(GetFrequency())};
}

#if SDL_VERSION_ATLEAST(2, 0, 18)

/* Returns the amount of milliseconds since SDL was initialized. */
[[nodiscard]] inline auto GetTicks() noexcept(noexcept(U64_Millis{Uint64{}}))
    -> U64_Millis
{
...
/* Returns the amount of milliseconds since SDL was initialized. */
[[nodiscard]] inline auto GetTicks() noexcept(noexcept(U32_Millis{Uint32{}}))
    -> U32_Millis
{
