...
TEST(ComponentSystem, SetComponentAttributeType)
{
  ...
  sys::make_component_attribute(registry, def, "A");
  ASSERT_EQ(PropertyType::String, sys::get_component_attribute_type(registry, def, "A"));

  sys::set_component_attribute_type(registry, def, "A", PropertyType::Integer);
  ASSERT_EQ(PropertyType::Integer, sys::get_component_attribute_type(registry, def, "A"));
...
TEST(ComponentSystem, SetComponentAttributeValue)
{
  ...
  sys::set_component_attribute_type(registry, def, "Foo", PropertyType::Boolean);
...
TEST(ComponentSystem, AddComponent)
{
  ...
  sys::set_component_attribute_type(registry, def, "X", PropertyType::Integer);
  sys::set_component_attribute_value(registry, def, "X", 42);

  sys::set_component_attribute_type(registry, def, "Y", PropertyType::Floating);
