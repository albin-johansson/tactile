...
TEST(ComponentSystem, SetComponentAttributeType)
{
  ...
  sys::set_component_attribute_type(registry, def, "A", AttributeType::Int);
  ASSERT_EQ(AttributeType::Int,
...
TEST(ComponentSystem, SetComponentAttributeValue)
{
  ...
  sys::set_component_attribute_type(registry, def, "Foo", AttributeType::Bool);
...
TEST(ComponentSystem, AddComponent)
{
  ...
  sys::set_component_attribute_type(registry, def, "X", AttributeType::Int);
  sys::set_component_attribute_value(registry, def, "X", 42);

  sys::set_component_attribute_type(registry, def, "Y", AttributeType::Float);
