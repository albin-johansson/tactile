...
rename_layer_dialog::rename_layer_dialog() : AStringInputDialog{"Rename Layer"}
{
...
auto rename_layer_dialog::validate(const DocumentModel&, std::string_view input) const
    -> bool
{
