...
class ICommand
{
 public:
  ...
  ///
  /// This function allows commands of the same type that target the same objects to be
  /// combined to drastically reduce the amount of near identical consecutive commands. This is
  ...
  ///
  /// \param cmd A command to try to merge into this command.
  ///
  /// \return
