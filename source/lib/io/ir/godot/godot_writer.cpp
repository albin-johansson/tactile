...
void _write_attributes(std::ostream& stream, const GdAttributes& attrs, StringView prefix)
{
...
void _write_components(std::ostream& stream, const GdMetaData& meta)
{
...
void _write_properties(std::ostream& stream, const GdMetaData& meta)
{
...
void _write_metadata(std::ostream& stream, const GdMetaData& meta)
{
...
void _write_ext_resources(std::ostream& stream, const GodotFile::ExtResources& resources)
{
  if (!resources.empty()) {
    stream << '\n';
...
void _write_atlas_textures(std::ostream& stream, const GodotScene& scene)
{
...
void _write_sprite_frames(std::ostream& stream, const GdSpriteFrames& sprite_frames)
{
...
void _write_shapes(std::ostream& stream, const GodotScene& scene)
{
...
void _write_tile_layer_animation_nodes(std::ostream& stream,
...
void _write_tile_layer(std::ostream& stream,
                       const GodotScene& scene,
                       const GdLayer& layer)
{
...
void _write_rectangle_object(std::ostream& stream, const GdObject& object)
{
...
void _write_polygon_object(std::ostream& stream, const GdObject& object)
{
...
void _write_object(std::ostream& stream, const GdObject& object)
{
...
void _write_object_layer(std::ostream& stream, const GdLayer& layer)
{
...
void _write_layers(std::ostream& stream, const GodotScene& scene)
{
