 ...
 *          of tile identifiers, to which then the specified compression method is
 *          applied. The result is subsequently encoded using Base64 as a plain string.
 *
 ...
 *
 * \note The compression method must be the same as when the tiles were encoded!
 *
