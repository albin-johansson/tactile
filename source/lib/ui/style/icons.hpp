...
#define TAC_ICON_DELETE ICON_FA_TRASH_CAN
...
#define TAC_ICON_DURATION ICON_FA_HOURGLASS
#define TAC_ICON_LOCATE ICON_FA_MAGNIFYING_GLASS_LOCATION
...
#define TAC_ICON_MAP ICON_FA_MAP
