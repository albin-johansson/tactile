...
TEST(StringConversion, StrToMultipleI32)
{
...
TEST(StringConversion, StrToMultipleU32)
{
...
TEST(StringConversion, StrToMultipleF32)
{
...
TEST(StringConversion, StrToU64)
{
  // Invalid inputs
...
TEST(StringConversion, StrToI64)
{
  // Invalid inputs
...
TEST(StringConversion, StrToF64)
{
  // Invalid inputs
