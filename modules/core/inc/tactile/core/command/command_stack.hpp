 ...
 *      Its sole purpose is to track whether any observable changes has been made
 *      since that state. This is particularly useful to track changes to documents.
...
class TACTILE_CORE_API CommandStack final {
 public:
   ...
   *
   * \details
   *    The notion of a clean command stack is used to prevent unnecessary saving of
   ...
   *
   * \details
   *    If the supplied capacity is smaller than the current capacity, then commands
