...
class History final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_last_opened_file();
...
inline std::string* History::release_last_opened_file() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = last_opened_file_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (last_opened_file_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    last_opened_file_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
