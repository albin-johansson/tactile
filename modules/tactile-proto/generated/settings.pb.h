...
enum OverlayPos : int {
  ...
  BOTTOM_LEFT = 2,
  BOTTOM_RIGHT = 3,
  OverlayPos_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  OverlayPos_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class Color final :
 ...
 public:
  ...
  void set_alpha(uint32_t value);
  private:
  uint32_t _internal_alpha() const;
  void _internal_set_alpha(uint32_t value);
  public:
...
class Settings final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD std::string* release_preferred_format();
  ...
  PROTOBUF_NODISCARD ::Tactile::Proto::Color* release_viewport_background();
  ...
  int32_t preferred_tile_width() const;
  void set_preferred_tile_width(int32_t value);
  private:
  int32_t _internal_preferred_tile_width() const;
  void _internal_set_preferred_tile_width(int32_t value);
  public:
  ...
  int32_t preferred_tile_height() const;
  void set_preferred_tile_height(int32_t value);
  private:
  int32_t _internal_preferred_tile_height() const;
  void _internal_set_preferred_tile_height(int32_t value);
  public:
  ...
  void set_command_capacity(uint64_t value);
  private:
  uint64_t _internal_command_capacity() const;
  void _internal_set_command_capacity(uint64_t value);
  public:
 ...
 private:
  ...
  int theme_;
  int32_t preferred_tile_width_;
  int32_t preferred_tile_height_;
  bool show_grid_;
  bool window_border_;
  bool restore_last_session_;
  bool restore_layout_;
  uint64_t command_capacity_;
...
inline uint32_t Color::_internal_alpha() const {
  return alpha_;
}
inline uint32_t Color::alpha() const {
  // @@protoc_insertion_point(field_get:Tactile.Proto.Color.alpha)
  return _internal_alpha();
}
inline void Color::_internal_set_alpha(uint32_t value) {
  _has_bits_[0] |= 0x00000008u;
  alpha_ = value;
}
inline void Color::set_alpha(uint32_t value) {
...
inline int32_t Settings::_internal_preferred_tile_width() const {
  return preferred_tile_width_;
}
inline int32_t Settings::preferred_tile_width() const {
  // @@protoc_insertion_point(field_get:Tactile.Proto.Settings.preferred_tile_width)
  return _internal_preferred_tile_width();
}
inline void Settings::_internal_set_preferred_tile_width(int32_t value) {
  _has_bits_[0] |= 0x00000008u;
  preferred_tile_width_ = value;
}
inline void Settings::set_preferred_tile_width(int32_t value) {
...
inline int32_t Settings::_internal_preferred_tile_height() const {
  return preferred_tile_height_;
}
inline int32_t Settings::preferred_tile_height() const {
  // @@protoc_insertion_point(field_get:Tactile.Proto.Settings.preferred_tile_height)
  return _internal_preferred_tile_height();
}
inline void Settings::_internal_set_preferred_tile_height(int32_t value) {
  _has_bits_[0] |= 0x00000010u;
  preferred_tile_height_ = value;
}
inline void Settings::set_preferred_tile_height(int32_t value) {
...
inline std::string* Settings::release_preferred_format() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = preferred_format_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (preferred_format_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    preferred_format_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
...
inline uint64_t Settings::_internal_command_capacity() const {
  return command_capacity_;
}
inline uint64_t Settings::command_capacity() const {
  // @@protoc_insertion_point(field_get:Tactile.Proto.Settings.command_capacity)
  return _internal_command_capacity();
}
inline void Settings::_internal_set_command_capacity(uint64_t value) {
  _has_bits_[0] |= 0x00000200u;
  command_capacity_ = value;
}
inline void Settings::set_command_capacity(uint64_t value) {
